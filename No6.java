 ...
 */
public class No6 extends Frame
{
  ...
  public void paint(Graphics g)
  {
    ...
    //Control points for the letter N.
    ...
    q3 = new QuadCurve2D.Double(xd[1],yd[1],xd[5],yd[5],xd[4],yd[4]);
    ...
    for (int i=1; i<=steps; i++)
    {
      ...
      q1 = new QuadCurve2D.Double(x[1],y[1],x[2],y[2],x[2],y[2]);
      q2 = new QuadCurve2D.Double(x[1],y[1],x[3],y[3],x[3],y[3]);
      q3 = new QuadCurve2D.Double(x[3],y[3],x[4],y[4],x[4],y[4]);
